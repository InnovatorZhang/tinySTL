    ...
    namespace test {
        namespace unordered_map_test {
            ...
            void unordered_map_test() {
                ...
                tinySTL::vector<PAIR > v;
                for (int i = 0; i < 5; ++i)
                    v.push_back(PAIR(5 - i, 5 - i));
                tinySTL::unordered_map<int, int> um1;
                tinySTL::unordered_map<int, int> um2(520);
                tinySTL::unordered_map<int, int> um3(520, tinySTL::hash<int>());
                tinySTL::unordered_map<int, int> um4(520, tinySTL::hash<int>(), tinySTL::equal_to<int>());
                tinySTL::unordered_map<int, int> um5(v.begin(), v.end());
                tinySTL::unordered_map<int, int> um6(v.begin(), v.end(), 100);
                tinySTL::unordered_map<int, int> um7(v.begin(), v.end(), 100, tinySTL::hash<int>());
                tinySTL::unordered_map<int, int> um8(v.begin(), v.end(), 100, tinySTL::hash<int>(),
                                                     tinySTL::equal_to<int>());
                tinySTL::unordered_map<int, int> um9(um5);
                tinySTL::unordered_map<int, int> um10(std::move(um5));
                tinySTL::unordered_map<int, int> um11;
                um11 = um6;
                tinySTL::unordered_map<int, int> um12;
                um12 = std::move(um6);
                tinySTL::unordered_map<int, int> um13{PAIR(1, 1), PAIR(2, 3), PAIR(3, 3)};
                tinySTL::unordered_map<int, int> um14;
            ...
            void unordered_multimap_test() {
                ...
                for (int i = 0; i < 5; ++i)
                    v.push_back(PAIR(5 - i, 5 - i));
                tinySTL::unordered_multimap<int, int> um1;
                tinySTL::unordered_multimap<int, int> um2(520);
                tinySTL::unordered_multimap<int, int> um3(520, tinySTL::hash<int>());
                tinySTL::unordered_multimap<int, int> um4(520, tinySTL::hash<int>(), tinySTL::equal_to<int>());
                tinySTL::unordered_multimap<int, int> um5(v.begin(), v.end());
                tinySTL::unordered_multimap<int, int> um6(v.begin(), v.end(), 100);
                tinySTL::unordered_multimap<int, int> um7(v.begin(), v.end(), 100, tinySTL::hash<int>());
                tinySTL::unordered_multimap<int, int> um8(v.begin(), v.end(), 100, tinySTL::hash<int>(),
                                                          tinySTL::equal_to<int>());
                tinySTL::unordered_multimap<int, int> um9(um5);
                tinySTL::unordered_multimap<int, int> um10(std::move(um5));
                tinySTL::unordered_multimap<int, int> um11;
                um11 = um6;
                tinySTL::unordered_multimap<int, int> um12;
                um12 = std::move(um6);
                tinySTL::unordered_multimap<int, int> um13{PAIR(1, 1), PAIR(2, 3), PAIR(3, 3)};
                tinySTL::unordered_multimap<int, int> um14;
                um14 = {PAIR(1, 1), PAIR(2, 3), PAIR(3, 3)};
