    ...
    namespace test {
        namespace string_test {
            ...
            void string_test() {
                ...
                tinySTL::string str;
                tinySTL::string str1(5, 'a');
                tinySTL::string str2(str1, 3);
                tinySTL::string str3(str1, 0, 3);
                tinySTL::string str4("abc");
                tinySTL::string str5("abcde", 3);
                tinySTL::string str6(s, s + 5);
                tinySTL::string str7(str1);
                tinySTL::string str8(std::move(str1));
                tinySTL::string str9;
                str9 = str2;
                tinySTL::string str10;
                str10 = std::move(str2);
                tinySTL::string str11;
                str11 = "123";
                tinySTL::string str12;
                str12 = 'A';
