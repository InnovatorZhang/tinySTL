    ...
    namespace test {
        namespace set_test {
            ...
            void set_test() {
                ...
                int a[] = {5, 4, 3, 2, 1};
                tinySTL::set<int> s1;
                tinySTL::set<int, tinySTL::greater<int>> s2;
                tinySTL::set<int> s3(a, a + 5);
                tinySTL::set<int> s4(a, a + 5);
                tinySTL::set<int> s5(s3);
                tinySTL::set<int> s6(std::move(s3));
                tinySTL::set<int> s7;
                s7 = s4;
                tinySTL::set<int> s8;
                s8 = std::move(s4);
            ...
            void multiset_test() {
                ...
                tinySTL::multiset<int, tinySTL::greater<int>> s2;
                tinySTL::multiset<int> s3(a, a + 5);
                tinySTL::multiset<int> s4(a, a + 5);
                tinySTL::multiset<int> s5(s3);
                tinySTL::multiset<int> s6(std::move(s3));
                tinySTL::multiset<int> s7;
                s7 = s4;
                tinySTL::multiset<int> s8;
                s8 = std::move(s4);
                tinySTL::multiset<int> s9{1, 2, 3, 4, 5};
