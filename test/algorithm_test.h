...
// algobase test:
            TEST(copy_test) {
                ...
                tinySTL::copy(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::copy(arr1 + 5, arr1 + 10, exp);
                tinySTL::copy(arr1 + 5, arr1 + 10, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_backward_test) {
                ...
                tinySTL::copy_backward(arr1, arr1 + 5, act + 5);
                EXPECT_CON_EQ(exp, act);
                std::copy_backward(exp.begin(), exp.begin() + 8, exp.begin() + 9);
                tinySTL::copy_backward(act, act + 8, act + 9);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_if_test) {
                ...
                tinySTL::copy_if(arr1, arr1 + 10, act, is_odd);
                EXPECT_CON_EQ(exp, act);
                std::copy_if(arr1, arr1 + 10, exp, is_even);
                tinySTL::copy_if(arr1, arr1 + 10, act, is_even);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(copy_n_test) {
                ...
                tinySTL::copy_n(arr1, 10, act);
                EXPECT_CON_EQ(exp, act);
                std::copy_n(arr1 + 5, 5, exp);
                tinySTL::copy_n(arr1 + 5, 5, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(move_backward_test) {
                ...
                tinySTL::move_backward(arr2, arr2 + 5, act + 5);
                EXPECT_CON_EQ(exp, act);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(equal_test) {
                ...
                EXPECT_EQ(std::equal(arr1, arr1 + 5, arr2),
                          tinySTL::equal(arr1, arr1 + 5, arr2));
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr1),
                          tinySTL::equal(v1.begin(), v1.end(), arr1));
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()),
                          tinySTL::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()));
            }

            TEST(fill_test) {
                int exp[10], act[10];
                tinySTL::vector<int> v1(10, 1);
                tinySTL::vector<int> v2(10, 2);
                std::fill(exp, exp + 10, 1);
                tinySTL::fill(act, act + 10, 1);
                EXPECT_CON_EQ(exp, act);
                std::fill(v1.begin(), v1.end(), 3);
                tinySTL::fill(v2.begin(), v2.end(), 3);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(fill_n_test) {
                ...
                int arr2[5];
                std::fill_n(arr2, 5, 1);
                tinySTL::fill_n(arr1, 5, 1);
                EXPECT_CON_EQ(arr1, arr2);
                std::fill_n(arr1 + 2, 3, 2);
                tinySTL::fill_n(arr2 + 2, 3, 2);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(lexicographical_compare_test) {
                ...
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5),
                          tinySTL::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5),
                          tinySTL::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()),
                          tinySTL::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()));
                EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()),
                          tinySTL::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()));
            }
            ...
            TEST(max_test) {
                ...
                char c1 = 'a', c2 = 'b';
                EXPECT_EQ(std::max(i1, i2), tinySTL::max(i1, i2));
                EXPECT_EQ(std::max(d1, d2), tinySTL::max(d1, d2));
                EXPECT_EQ(std::max(c1, c2), tinySTL::max(c1, c2));
            }
            ...
            TEST(min_test) {
                ...
                double d1 = 1.1, d2 = 2.2;
                char c1 = 'a', c2 = 'b';
                EXPECT_EQ(std::min(i1, i2), tinySTL::min(i1, i2));
                EXPECT_EQ(std::min(d1, d2), tinySTL::min(d1, d2));
                EXPECT_EQ(std::min(c1, c2), tinySTL::min(c1, c2));
            }
            ...
            TEST(mismatch_test) {
                ...
                auto p2 = tinySTL::mismatch(arr1, arr1 + 7, arr2);
                auto p3 = std::mismatch(arr1, arr1 + 7, arr3);
                auto p4 = tinySTL::mismatch(arr1, arr1 + 7, arr3);
                auto p5 = std::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
                auto p6 = tinySTL::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
...
// heap_algo test
            TEST(make_heap_test) {
                ...
                tinySTL::make_heap(arr2, arr2 + 9);
                std::make_heap(arr3, arr3 + 9);
                tinySTL::make_heap(arr4, arr4 + 9);
                std::make_heap(arr5, arr5 + 10, std::greater<int>());
                tinySTL::make_heap(arr6, arr6 + 10, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
            ...
            TEST(pop_heap_test) {
                ...
                tinySTL::pop_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(push_heap_test) {
                ...
                tinySTL::push_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(sort_heap_test) {
                ...
                tinySTL::sort_heap(arr2, arr2 + 9);
                std::sort_heap(arr3, arr3 + 9, std::greater<int>());
                tinySTL::sort_heap(arr4, arr4 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
            }
...
// set_algo test
            TEST(set_difference_test) {
                ...
                tinySTL::set_difference(arr1, arr1 + 9, arr2, arr2 + 6, act);
                EXPECT_CON_EQ(exp, act);
                std::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, exp);
                tinySTL::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, act);
                EXPECT_CON_EQ(exp, act);
                std::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
                tinySTL::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_intersection_test) {
                ...
                tinySTL::set_intersection(arr1, arr1 + 9, arr2, arr2 + 6, act);
                EXPECT_CON_EQ(exp, act);
                std::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, exp);
                tinySTL::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, act);
                EXPECT_CON_EQ(exp, act);
                std::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
                tinySTL::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_symmetric_difference_test) {
                ...
                tinySTL::set_symmetric_difference(arr1, arr1 + 5, arr2, arr2 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, exp);
                tinySTL::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
                tinySTL::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(set_union_test) {
                ...
                tinySTL::set_union(arr1, arr1 + 5, arr2, arr2 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_union(arr1, arr1 + 5, arr3, arr3 + 5, exp);
                tinySTL::set_union(arr1, arr1 + 5, arr3, arr3 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::set_union(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
                tinySTL::set_union(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
...
// numeric test
            TEST(accumulate_test) {
                ...
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0),
                          tinySTL::accumulate(arr1, arr1 + 5, 0));
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 5),
                          tinySTL::accumulate(arr1, arr1 + 5, 5));
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0, std::minus<int>()),
                          tinySTL::accumulate(arr1, arr1 + 5, 0, std::minus<int>()));
            }
            ...
            TEST(adjacent_difference_test) {
                ...
                tinySTL::adjacent_difference(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::adjacent_difference(arr2, arr2 + 5, exp, std::minus<int>());
                tinySTL::adjacent_difference(arr2, arr2 + 5, act, std::minus<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(inner_product_test) {
                ...
                EXPECT_EQ(std::inner_product(arr1, arr1 + 5, arr3, 0),
                          tinySTL::inner_product(arr1, arr1 + 5, arr3, 0));
                EXPECT_EQ(std::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()),
                          tinySTL::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()));
            }
...
// algo test
            TEST(adjacent_find_test) {
                ...
                EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5),
                          tinySTL::adjacent_find(arr1, arr1 + 5));
                EXPECT_EQ(std::adjacent_find(arr2, arr2 + 5),
                          tinySTL::adjacent_find(arr2, arr2 + 5));
                EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5, std::greater<int>()),
                          tinySTL::adjacent_find(arr1, arr1 + 5, std::greater<int>()));
            }
            ...
            TEST(all_of_test) {
                ...
                EXPECT_EQ(std::all_of(arr1, arr1 + 5, is_odd),
                          tinySTL::all_of(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::all_of(arr2, arr2 + 5, is_odd),
                          tinySTL::all_of(arr2, arr2 + 5, is_odd));
            }
            ...
            TEST(find_test) {
                int arr1[] = {1, 2, 3, 4, 5};
                EXPECT_EQ(std::find(arr1, arr1 + 5, 3), tinySTL::find(arr1, arr1 + 5, 3));
                EXPECT_EQ(std::find(arr1, arr1 + 5, 6), tinySTL::find(arr1, arr1 + 5, 6));
            }
            ...
            TEST(find_end_test) {
                ...
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr2, arr2 + 1),
                          tinySTL::find_end(arr1, arr1 + 8, arr2, arr2 + 1));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
                          tinySTL::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
                          tinySTL::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
                EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()),
                          tinySTL::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()));
            }
            ...
            TEST(for_each_test) {
                ...
                tinySTL::for_each(v1.begin(), v1.end(), arr_sum);
            ...
            TEST(generate_test) {
                ...
                tinySTL::generate(arr2, arr2 + 5, gen);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(includes_test) {
                ...
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v2.begin(), v2.end()),
                          tinySTL::includes(v1.begin(), v1.end(), v2.begin(), v2.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v3.begin(), v3.end()),
                          tinySTL::includes(v1.begin(), v1.end(), v3.begin(), v3.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v4.begin(), v4.end()),
                          tinySTL::includes(v1.begin(), v1.end(), v4.begin(), v4.end()));
                EXPECT_EQ(std::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()),
                          tinySTL::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()));
            }
            ...
            TEST(is_heap_test) {
                ...
                EXPECT_EQ(std::is_heap(arr1, arr1 + 10), tinySTL::is_heap(arr1, arr1 + 10));
                EXPECT_EQ(std::is_heap(arr2, arr2 + 10, std::less<int>()),
                          tinySTL::is_heap(arr2, arr2 + 10, std::less<int>()));
                EXPECT_EQ(std::is_heap(arr3, arr3 + 10), tinySTL::is_heap(arr3, arr3 + 10));
                EXPECT_EQ(std::is_heap(arr4, arr4 + 10), tinySTL::is_heap(arr4, arr4 + 10));
            }
            ...
            TEST(is_sorted_test) {
                ...
                int arr3[] = {5, 4, 3, 2, 1};
                int arr4[] = {1, 2, 5, 4, 3};
                EXPECT_EQ(std::is_sorted(arr1, arr1 + 5), tinySTL::is_sorted(arr1, arr1 + 5));
                EXPECT_EQ(std::is_sorted(arr2, arr2 + 5), tinySTL::is_sorted(arr2, arr2 + 5));
                EXPECT_EQ(std::is_sorted(arr3, arr3 + 5, std::less<int>()),
                          tinySTL::is_sorted(arr3, arr3 + 5, std::less<int>()));
                EXPECT_EQ(std::is_sorted(arr4, arr4 + 5, std::less<int>()),
                          tinySTL::is_sorted(arr4, arr4 + 5, std::less<int>()));
            }

            TEST(lower_bound_test) {
                int arr1[] = {1, 2, 3, 3, 3, 4, 5};
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 1),
                          tinySTL::lower_bound(arr1, arr1 + 7, 1));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 2),
                          tinySTL::lower_bound(arr1, arr1 + 7, 2));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 3),
                          tinySTL::lower_bound(arr1, arr1 + 7, 3));
                EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 5, std::less<int>()),
                          tinySTL::lower_bound(arr1, arr1 + 7, 5, std::less<int>()));
            }
            ...
            TEST(max_elememt_test) {
                ...
                EXPECT_PTR_EQ(std::max_element(arr1, arr1 + 9),
                              tinySTL::max_element(arr1, arr1 + 9));
                EXPECT_PTR_EQ(std::max_element(arr2, arr2 + 6, std::less<double>()),
                              tinySTL::max_element(arr2, arr2 + 6, std::less<double>()));
            }

            TEST(median_test) {
                int ia = 2, ib = 1, ic = 3;
                double da = 3.1, db = 3.0, dc = 3.2;
                EXPECT_EQ(2, tinySTL::median(ia, ib, ic));
                EXPECT_EQ(3.1, tinySTL::median(da, db, dc, std::greater<double>()));
            }
            ...
            TEST(merge_test) {
                ...
                tinySTL::merge(arr3, arr3 + 5, arr4, arr4 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::merge(arr1, arr1 + 5, arr2, arr2 + 5, exp, std::less<int>());
                tinySTL::merge(arr3, arr3 + 5, arr4, arr4 + 5, act, std::less<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(is_permutation_test) {
                ...
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2),
                          tinySTL::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3),
                          tinySTL::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2, std::equal_to<int>()),
                          tinySTL::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5, std::equal_to<int>()));
                EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3, std::equal_to<int>()),
                          tinySTL::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5, std::equal_to<int>()));
            }
            ...
            TEST(next_permutation_test) {
                ...
                while (tinySTL::next_permutation(arr1, arr1 + 4)) n2++;
                EXPECT_EQ(n1, n2);
                for (; n1 > 0; n1--) {
                    std::next_permutation(arr1, arr1 + 4);
                    tinySTL::next_permutation(arr2, arr2 + 4);
                    EXPECT_CON_EQ(arr1, arr2);
                }
                std::next_permutation(arr1, arr1 + 4, std::greater<int>());
                tinySTL::next_permutation(arr2, arr2 + 4, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(none_of_test) {
                ...
                EXPECT_EQ(std::none_of(arr1, arr1 + 5, is_even),
                          tinySTL::none_of(arr1, arr1 + 5, is_even));
                EXPECT_EQ(std::none_of(arr2, arr2 + 5, is_even),
                          tinySTL::none_of(arr2, arr2 + 5, is_even));
                EXPECT_EQ(std::none_of(arr3, arr3 + 5, is_even),
                          tinySTL::none_of(arr3, arr3 + 5, is_even));
            }
            ...
            TEST(nth_element_test) {
                ...
                tinySTL::nth_element(arr1, arr1 + 4, arr1 + 9);
                tinySTL::nth_element(arr2, arr2 + 2, arr2 + 9);
                tinySTL::nth_element(arr3, arr3 + 8, arr3 + 9, std::less<int>());
                tinySTL::nth_element(arr4, arr4 + 3, arr4 + 16, std::less<int>());
            ...
            TEST(partial_sort_test) {
                ...
                tinySTL::partial_sort(arr2, arr2 + 2, arr2 + 9);
                std::partial_sort(arr3, arr3 + 5, arr3 + 13, std::greater<int>());
                tinySTL::partial_sort(arr4, arr4 + 5, arr4 + 13, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
            }
            ...
            TEST(partial_sort_copy_test) {
                ...
                tinySTL::partial_sort_copy(arr1, arr1 + 9, act, act + 5);
                EXPECT_CON_EQ(exp, act);
                std::partial_sort_copy(arr2, arr2 + 9, exp, exp + 5);
                tinySTL::partial_sort_copy(arr2, arr2 + 9, act, act + 5);
                EXPECT_CON_EQ(exp, act);
                std::partial_sort_copy(arr3, arr3 + 15, exp, exp + 5, std::greater<int>());
                tinySTL::partial_sort_copy(arr3, arr3 + 15, act, act + 5, std::greater<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(partition_test) {
                ...
                tinySTL::partition(arr2, arr2 + 9, is_odd);
                EXPECT_CON_EQ(arr1, arr2);
                std::partition(arr1, arr1 + 9, is_even);
                tinySTL::partition(arr2, arr2 + 9, is_even);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(partition_copy_test) {
                ...
                tinySTL::partition_copy(arr1, arr1 + 10, act_true, act_false, is_odd);
            ...
            TEST(prev_permutation_test) {
                ...
                while (tinySTL::prev_permutation(arr1, arr1 + 4)) n2++;
                EXPECT_EQ(n1, n2);
                for (; n1 > 0; n1--) {
                    std::prev_permutation(arr1, arr1 + 4);
                    tinySTL::prev_permutation(arr2, arr2 + 4);
                    EXPECT_CON_EQ(arr1, arr2);
                }
                std::prev_permutation(arr1, arr1 + 4, std::greater<int>());
                tinySTL::prev_permutation(arr2, arr2 + 4, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(random_shuffle_test) {
                ...
                for (int i = 0; i < 9; ++i) {
                    ...
                    tinySTL::random_shuffle(arr1, arr1 + 9);
                    EXPECT_CON_NE(arr1, arr2);
                }
                std::copy(arr1, arr1 + 9, arr2);
                tinySTL::random_shuffle(arr1, arr1 + 9, r);
                EXPECT_CON_NE(arr1, arr2);
            }
            ...
            TEST(remove_test) {
                ...
                tinySTL::remove(v2.begin(), v2.end(), 3);
                EXPECT_CON_EQ(v1, v2);
                std::remove(v1.begin(), v1.end(), 6);
                tinySTL::remove(v2.begin(), v2.end(), 6);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(remove_copy_test) {
                ...
                tinySTL::remove_copy(arr2, arr2 + 8, act, 6);
                EXPECT_CON_EQ(exp, act);
                std::remove_copy(arr1, arr1 + 5, exp, 3);
                tinySTL::remove_copy(arr2, arr2 + 5, act, 3);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(remove_copy_if_test) {
                ...
                tinySTL::remove_copy_if(arr1, arr1 + 10, act, is_odd);
                EXPECT_CON_EQ(exp, act);
                std::remove_copy_if(arr1, arr1 + 10, exp, is_even);
                tinySTL::remove_copy_if(arr1, arr1 + 10, act, is_even);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(remove_if_test) {
                ...
                tinySTL::remove_if(v2.begin(), v2.end(), is_odd);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(replace_test) {
                ...
                tinySTL::replace(arr2, arr2 + 9, 1, 4);
                EXPECT_CON_EQ(arr1, arr2);
                std::replace(arr1, arr1 + 9, 2, 5);
                tinySTL::replace(arr2, arr2 + 9, 2, 5);
                EXPECT_CON_EQ(arr1, arr2);
                std::replace(arr1, arr1 + 9, 3, 6);
                tinySTL::replace(arr2, arr2 + 9, 3, 6);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(replace_copy_test) {
                ...
                tinySTL::replace_copy(arr1, arr1 + 9, act, 1, 4);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy(arr1, arr1 + 9, exp, 2, 5);
                tinySTL::replace_copy(arr1, arr1 + 9, act, 2, 5);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy(arr1, arr1 + 9, exp, 3, 6);
                tinySTL::replace_copy(arr1, arr1 + 9, act, 3, 6);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(replace_copy_if_test) {
                ...
                tinySTL::replace_copy_if(arr1, arr1 + 10, act, is_odd, 1);
                EXPECT_CON_EQ(exp, act);
                std::replace_copy_if(arr1, arr1 + 10, exp, is_even, 2);
                tinySTL::replace_copy_if(arr1, arr1 + 10, act, is_even, 2);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(replace_if_test) {
                ...
                tinySTL::replace_if(v2.begin(), v2.end(), is_odd, 1);
                EXPECT_CON_EQ(v1, v2);
                std::replace_if(v1.begin(), v1.end(), is_even, 2);
                tinySTL::replace_if(v2.begin(), v2.end(), is_even, 2);
                EXPECT_CON_EQ(v1, v2);
            }
            ...
            TEST(reverse_test) {
                ...
                tinySTL::reverse(arr2, arr2 + 9);
                EXPECT_CON_EQ(arr1, arr2);
                std::reverse(arr1, arr1 + 5);
                tinySTL::reverse(arr2, arr2 + 5);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(reverse_copy_test) {
                ...
                tinySTL::reverse_copy(arr1, arr1 + 5, act);
                EXPECT_CON_EQ(exp, act);
                std::reverse_copy(arr1 + 4, arr1 + 9, exp);
                tinySTL::reverse_copy(arr1 + 4, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(rotate_copy_test) {
                ...
                tinySTL::rotate_copy(arr1, arr1 + 5, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
                std::rotate_copy(arr1, arr1, arr1 + 9, exp);
                tinySTL::rotate_copy(arr1, arr1, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
                std::rotate_copy(arr1, arr1 + 9, arr1 + 9, exp);
                tinySTL::rotate_copy(arr1, arr1 + 9, arr1 + 9, act);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(sort_test) {
                ...
                tinySTL::sort(arr2, arr2 + 14);
                std::sort(arr3, arr3 + 20);
                tinySTL::sort(arr4, arr4 + 20);
                std::sort(arr5, arr5 + 9, std::greater<int>());
                tinySTL::sort(arr6, arr6 + 9, std::greater<int>());
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr3, arr4);
                EXPECT_CON_EQ(arr5, arr6);
            }
            ...
            TEST(swap_ranges_test) {
                ...
                tinySTL::swap_ranges(arr2, arr2 + 6, arr4);
                std::swap_ranges(arr1, arr1 + 3, arr5);
                tinySTL::swap_ranges(arr2, arr2 + 3, arr6);
                EXPECT_CON_EQ(arr1, arr2);
                EXPECT_CON_EQ(arr1, arr2);
            }
            ...
            TEST(transform_test) {
                ...
                tinySTL::transform(arr1, arr1 + 9, act, unary_op);
                EXPECT_CON_EQ(exp, act);
                std::transform(arr1, arr1 + 9, arr2, exp, binary_op);
                tinySTL::transform(arr1, arr1 + 9, arr2, act, binary_op);
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(unique_copy_test) {
                ...
                tinySTL::unique_copy(arr1, arr1 + 10, act);
                EXPECT_CON_EQ(exp, act);
                std::unique_copy(arr2, arr2 + 9, exp, std::equal_to<int>());
                tinySTL::unique_copy(arr2, arr2 + 9, act, std::equal_to<int>());
                EXPECT_CON_EQ(exp, act);
            }
            ...
            TEST(upper_bound_test) {
                ...
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 0),
                          tinySTL::upper_bound(arr1, arr1 + 9, 0));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 1),
                          tinySTL::upper_bound(arr1, arr1 + 9, 1));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 3),
                          tinySTL::upper_bound(arr1, arr1 + 9, 3));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 6, std::less<int>()),
                          tinySTL::upper_bound(arr1, arr1 + 9, 6, std::less<int>()));
